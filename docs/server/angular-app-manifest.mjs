...
export default {
  ...
  assets: {
    ...
    'faq/index.html': {size: 27031, hash: '21a9535a3265f527bb728b854cdba42729a7c939856b23e2b4b366e86f781c18', text: () => import('./assets-chunks/faq_index_html.mjs').then(m => m.default)},
